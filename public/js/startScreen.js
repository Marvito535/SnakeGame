class StartScreen {
    display(context, canvasWidth, canvasHeight) {
        ...
        const baseFontSize = Math.max(24, canvasHeight * 0.08); // At least 24px

        // Title Text
        context.fillStyle = "green";
        context.font = `${Math.floor(baseFontSize * 0.09)}px Arial`; // Adjust font size based on  baseFontSize
        ...
        // Other instructions 
        context.font = `${Math.floor(canvasHeight * 0.02)}px Arial`; // Adjust font size based on canvas height
